...
var superPow = function(a, b) {
    ...
    for(var i = 0; i < b.length; i++){
        ...
        switch(b[i]){
            case 9:
                num = Math.pow(a, 3) % MOD;
                num = Math.pow(num, 3) % MOD;
                break;
            case 8:
                num = Math.pow(a, 2) % MOD;
                num = Math.pow(num, 4) % MOD;
                break;
            case 7:
                num = (Math.pow(a, 3) % MOD) * (Math.pow(a, 4) % MOD) % MOD;
                break;
            case 6:
                num = Math.pow(a, 2) % MOD;
                num = Math.pow(num, 3) % MOD;
